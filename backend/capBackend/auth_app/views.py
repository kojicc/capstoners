...
class LogoutView(APIView):
    ...
    def get(self, request):
        response = Response()
        response.delete_cookie('jwt_access_token', path='/', samesite='Strict')
        response.delete_cookie('jwt_refresh_token', path='/', samesite='Strict')
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if 'access' in response.data:
                ...
                response.set_cookie(key='jwt_access_token', value=new_access_token, httponly=True, samesite='Strict')
