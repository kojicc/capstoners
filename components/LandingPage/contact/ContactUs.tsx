...
import { IconArrowRight, IconChecks, IconDeviceLandlinePhone, IconFileTime, IconMail, IconMap2, IconReceipt, IconStatusChange } from '@tabler/icons-react';
...
<Container fluid>
<Title pb={60} pl={80} order={1} tt='uppercase' >Location</Title>


<iframe
    style={{ paddingLeft:160,paddingRight:160, border: 0, width: '100%', height: '270px' }}
